...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
    KC_LALT,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_LGUI,\
  ...
  [_ADJUST] = LAYOUT_kc( \
    RST, LRST, LTOG, XXXXX, XXXXX, XXXXX,\
      XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, _____,\
    LMOI, LHUI, LSAI, LVAI, XXXXX, XXXXX, XXXXX,\
      XXXXX, XXXXX, XXXXX, XXXXX, LCTRL,\
    LMOD, LHUD, LSAD, LVAD, XXXXX, XXXXX, XXXXX,\
      XXXXX, XXXXX, XXXXX, XXXXX, NUMLOCK,\
